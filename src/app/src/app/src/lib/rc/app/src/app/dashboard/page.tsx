      ...
      <div className="max-w-7xl mx-auto p-8">
        <div className="flex justify-between items-center mb-10">
          ...
          <button 
            ...
            className="bg-blue-600 text-white px-6 py-3 rounded-xl flex items-center gap-3 hover:bg-blue-700 transition-all"
          >
        ...
        <div className="bg-white rounded-2xl shadow overflow-hidden">
          {requests.length === 0 ? (
            <p className="p-20 text-center text-gray-500 text-lg">
              No payment requests yet.<br />Click "New Payment Request" to create one.
            </p>
          ) : (
